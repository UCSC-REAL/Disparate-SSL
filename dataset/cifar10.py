        ...
        for i in range(10):
            ...
            if unbalance:
                if i < 5:
                    ...
                    unlabel_per_class = num_per_class - n_labeled_per_class - 500
                    train_labeled_idxs.extend(idxs[:n_labeled_per_class//2])
                    train_unlabeled_idxs.extend(idxs[n_labeled_per_class//2:unlabel_per_class//2 + n_labeled_per_class//2])
                    val_idxs.extend(idxs[unlabel_per_class//2 + n_labeled_per_class//2:])
            else:
                # balance
                train_labeled_idxs.extend(idxs[:n_labeled_per_class])
                train_unlabeled_idxs.extend(idxs[n_labeled_per_class:-500])
